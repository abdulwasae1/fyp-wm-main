...
import MarketingLayout from "@/app/home/layout";
...
const HomePage = () => {
                    ...
                    <div className="hidden md:flex relative items-center justify-center mt-8 md:mt-12 w-full">
                        <Link href="/sign-in" className="flex items-center justify-center w-max rounded-full border-t border-foreground/30 bg-white/20 backdrop-blur-lg px-2 py-1 md:py-2 gap-2 md:gap-8 shadow-3xl shadow-background/40 cursor-pointer select-none">
                            <p className="text-foreground text-sm text-center md:text-base font-medium pl-4 pr-4 lg:pr-0">
                                ✨ {"  "} Start trimixing your content now!
                            </p>
        ...
        <Container>
            <div className="max-w-md mx-auto text-start md:text-center">
                ...
                <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                    Three steps to repurpose your content with AI
                </h2>
    ...
    <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
            <div className="max-w-md mx-auto text-start md:text-center">
                <SectionBadge title="Innovations" />
                <h2 className="text-3xl lg:text-4xl font-semibold mt-6">
                    Experience the tools that set us apart
                </h2>
                <p className="text-muted-foreground mt-6">
                    Trimix offers a range automated tools to help you Create engaging shorts for your business in no time.
                </p>
            </div>
        </Container>
        <Container>
    ...
    <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
            <div className="max-w-md mx-auto text-start md:text-center">
                ...
                <p className="text-muted-foreground mt-6">
                    Choose the best plan for your business and start advertising with Artificial Intelligence today
                </p>
            </div>
        </Container>
    ...
    <Wrapper className="flex flex-col items-center justify-center py-12 relative">
        ...
        <Container>
            <div className="max-w-md mx-auto text-start md:text-center">
                ...
                <p className="text-muted-foreground mt-6">
                    See how Trimix empowers businesses of all sizes. Here&apos;s what real people are saying on Twitter
                </p>
            </div>
        </Container>
        <Container>
            ...
            <LampContainer>
                <div className="flex flex-col items-center justify-center relative w-full text-center">
                    ...
                    <p className="text-muted-foreground mt-6 max-w-md mx-auto">
                        Generate engaging content with Trimix&apos;s intuitive Video Repurposing and powerful AI assistant.
                    </p>
